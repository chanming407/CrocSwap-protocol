...
* [Token Risk](./docs/TokenModel.md) - CrocSwap expects fairly stringent conformance requirements to guarantee safe and defined behavior. Users interacting with pools on non-compliant or malicious tokens risk loss of funds.
